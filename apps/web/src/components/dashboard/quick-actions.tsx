...
function ActionCard({ meta, title, description, icon, ctaLabel, primary = false }: ActionCardProps) {
  if (primary) {
    return (
      <div className="flex items-start gap-4 rounded-2xl border border-[#0A0A0A] bg-[#0A0A0A] p-6 text-white transition-all hover:-translate-y-0.5 hover:shadow-[0_16px_32px_-10px_rgba(10,10,10,0.4)]">
        ...
        <div className="flex-1">
          <p className="mb-2.5 text-[11px] font-semibold uppercase tracking-[0.06em] text-[#C6FF3D]">{meta}</p>
          <h3 className="mb-1 text-base font-bold tracking-tight">{title}</h3>
          <p className="mb-3.5 text-[13px] text-gray-300">{description}</p>
          <button
            type="button"
            className="inline-flex h-9 items-center rounded-lg bg-[#C6FF3D] px-3.5 text-xs font-bold text-[#0A0A0A] transition-colors hover:bg-[#D4FF7A]"
          >
            {ctaLabel}
          </button>
        </div>
  ...
  return (
    <div className="flex items-start gap-4 rounded-2xl border border-gray-200 bg-white p-6 transition-all hover:-translate-y-0.5 hover:border-gray-300 hover:shadow-md">
      ...
      <div className="flex-1">
        <p className="mb-2.5 text-[11px] font-semibold uppercase tracking-[0.06em] text-gray-500">{meta}</p>
        ...
        <button
          type="button"
          className="inline-flex h-9 items-center rounded-lg border border-gray-200 bg-white px-3.5 text-xs font-bold text-[#0A0A0A] transition-colors hover:border-gray-300"
        >
          {ctaLabel}
        </button>
      </div>
