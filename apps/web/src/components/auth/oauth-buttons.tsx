...
const BUTTON_CLASS =
  "flex h-11 w-full items-center justify-center gap-2.5 rounded-lg border border-line bg-surface px-4 text-sm font-semibold text-ink transition-all hover:-translate-y-0.5 hover:border-line-strong hover:bg-surface-2 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-accent/25";

function notReady(provider: string) {
  toast(`El acceso con ${provider} estará disponible muy pronto.`);
}
